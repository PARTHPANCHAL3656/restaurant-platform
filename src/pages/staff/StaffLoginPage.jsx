        ...
        <div className="bg-[#1A1F2C]/80 backdrop-blur-xl border border-[#E5E1DA]/10 p-8 md:p-12 shadow-2xl rounded-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full h-[56px] mt-8 bg-saffron-gold text-ink-navy font-cta-label text-cta-label uppercase tracking-widest transition-all duration-300 rounded-none shadow-md
                ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:brightness-110 active:scale-[0.98] cursor-pointer'}`}
            >
              {loading ? (
