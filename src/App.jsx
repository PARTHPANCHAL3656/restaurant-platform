...
const StaffSettingsBillingPage = React.lazy(() => import('./pages/staff/StaffSettingsBillingPage'));
const StaffSettingsStaffPage = React.lazy(() => import('./pages/staff/StaffSettingsStaffPage'));
const StaffSettingsLinksPage = React.lazy(() => import('./pages/staff/StaffSettingsLinksPage'));
      ...
      <div className="flex-grow lg:pl-[300px] pt-[64px] lg:pt-0 min-h-screen flex flex-col justify-between">
        {['/order-status', '/track-order', '/cart', '/bill'].includes(location.pathname) && !tableToken ? (
          <div className="flex-grow flex flex-col items-center justify-center p-6 text-center max-w-md mx-auto space-y-6">
            ...
            <p className="font-body-md text-sm text-subtle-text leading-relaxed font-sans">
              Please scan your table QR code to access the digital menu, place orders, and view your bill.
            </p>
          </div>
        ) : (
          <Routes>
      ...
      <ErrorBoundary>
        <Routes>
          ...
          <Route element={<StaffLayout />}>
            ...
            <Route path="/staff/settings/billing" element={<StaffSettingsBillingPage />} />
            <Route path="/staff/settings/staff" element={<StaffSettingsStaffPage />} />
            <Route path="/staff/settings/links" element={<StaffSettingsLinksPage />} />
          </Route>
        </Routes>
      </ErrorBoundary>
    );
